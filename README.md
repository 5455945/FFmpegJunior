# FFmpegJunior
**由 https://github.com/yinwenjie/FFmpeg_Tutorial 修改而来。**
** FFmpeg SDK为：**
** ffmpeg-3.2.2-win32-dev **
** ffmpeg-3.2.2-win32-shared **
** ffmpeg-3.2.2-win64-dev **
** ffmpeg-3.2.2-win64-shared **
...
使用exe测试可以下载static版本：
[ffmpeg-3.2.2-win32-static.zip](https://ffmpeg.zeranoe.com/builds/win32/static/ffmpeg-3.2.2-win32-static.zip)
[ffmpeg-3.2.2-win64-static.zip](https://ffmpeg.zeranoe.com/builds/win64/static/ffmpeg-3.2.2-win64-static.zip)
